/*
 * opcode dis - potentially shared between dis and other diss which
...
export const dis = {
    ...
    init: function() {
        ...
        window.console.log('Initializing opcodes...');
        dis.opmap = {};
        ...
        dis.def_op('NOP', 9);
        dis.def_unary_op('UNARY_POSITIVE', 10);
        dis.def_unary_op('UNARY_NEGATIVE', 11);
        dis.def_unary_op('UNARY_NOT', 12);

        dis.def_unary_op('UNARY_INVERT', 15);

        dis.def_binary_op('BINARY_POWER', 19);
        dis.def_binary_op('BINARY_MULTIPLY', 20);

        dis.def_binary_op('BINARY_MODULO', 22);
        dis.def_binary_op('BINARY_ADD', 23);
        dis.def_binary_op('BINARY_SUBTRACT', 24);
        dis.def_binary_op('BINARY_SUBSCR', 25);
        dis.def_binary_op('BINARY_FLOOR_DIVIDE', 26);
        dis.def_binary_op('BINARY_TRUE_DIVIDE', 27);
        dis.def_inplace_op('INPLACE_FLOOR_DIVIDE', 28);
        dis.def_inplace_op('INPLACE_TRUE_DIVIDE', 29);

        dis.def_op('STORE_MAP', 54);
        dis.def_inplace_op('INPLACE_ADD', 55);
        dis.def_inplace_op('INPLACE_SUBTRACT', 56);
        dis.def_inplace_op('INPLACE_MULTIPLY', 57);

        dis.def_inplace_op('INPLACE_MODULO', 59);
        dis.def_op('STORE_SUBSCR', 60);
        dis.def_op('DELETE_SUBSCR', 61);
        dis.def_binary_op('BINARY_LSHIFT', 62);
        dis.def_binary_op('BINARY_RSHIFT', 63);
        dis.def_binary_op('BINARY_AND', 64);
        dis.def_binary_op('BINARY_XOR', 65);
        dis.def_binary_op('BINARY_OR', 66);
        dis.def_inplace_op('INPLACE_POWER', 67);
        ...
        dis.def_inplace_op('INPLACE_LSHIFT', 75);
        dis.def_inplace_op('INPLACE_RSHIFT', 76);
        dis.def_inplace_op('INPLACE_AND', 77);
        dis.def_inplace_op('INPLACE_XOR', 78);
        dis.def_inplace_op('INPLACE_OR', 79);
